...
pub async fn cmd_run(
    ...
    match driver_name {
        ...
        "bedrock" => {
            let driver = crate::driver::bedrock::BedrockDriver::from_env(config_model);
            crate::events::ThrulineEvent::PipelineStart {
                run_id: run_id.clone(),
                ts: chrono::Utc::now(),
                pipeline: pipeline.clone(),
        ...
        other => anyhow::bail!("unknown driver '{}' \u{2014} use stdio, api, bedrock, ollama, openai, or mock", other),
    }
